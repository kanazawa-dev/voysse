...
Consulta la [guía de inicio rápido](https://docs.voysse.cl/docs/getting-started) para el paso a paso completo.
...
- [Más información](https://docs.voysse.cl/docs/agents)
...
- [Más información](https://docs.voysse.cl/docs/knowledge-base)
...
- [Más información](https://docs.voysse.cl/docs/ai-providers)
...
- [Más información](https://docs.voysse.cl/docs/custom-tools)
...
- [Más información](https://docs.voysse.cl/docs/inbox)
...
La documentación completa está en [**docs.voysse.cl**](https://docs.voysse.cl/docs).

| Guía | Qué cubre |
| --- | --- |
| [Inicio rápido](https://docs.voysse.cl/docs/getting-started) | Ejecutar el stack con Docker y crear tu primera agencia |
| [Configuración](https://docs.voysse.cl/docs/configuration) | Variables de entorno, secretos, puertos y el gateway |
| [Arquitectura](https://docs.voysse.cl/docs/architecture) | Los servicios, el modelo de datos y el aislamiento de tenants |
| [Self-hosting](https://docs.voysse.cl/docs/self-hosting) | Desplegar en un servidor, backups, actualizaciones y troubleshooting |
| [Contribuir](https://docs.voysse.cl/docs/contributing) | Ejecutar el proyecto localmente, tests y convenciones |
| [Roadmap](https://docs.voysse.cl/docs/roadmap) | Qué quiere construir el equipo a continuación |
