  ...
  return <div className="flex w-full flex-col gap-6">
    ...
    {tab === "details" && <form className="space-y-6" onSubmit={saveConfig}>
      ...
      <Card className="grid gap-6 p-5 md:grid-cols-[minmax(12rem,1fr)_2fr]"><div className="[&_h2]:font-semibold [&_p]:mt-1 [&_p]:text-sm [&_p]:text-muted-foreground"><h3 className="font-heading">{t("agents.detail.aiModelHeading")}</h3><p>{t("agents.detail.aiModelCopy")}</p></div><div className="space-y-4">
        ...
        <div className="space-y-2"><div className="flex justify-between text-sm"><span>{t("agents.detail.temperatureLabel")}</span><strong>{temperature.toFixed(1)}/2</strong></div><input type="range" min="0" max="2" step="0.1" value={temperature} onChange={(e) => setTemperature(Number(e.target.value))} /><span className="mt-1.5 text-xs text-muted-foreground">{t("agents.detail.temperatureHint")}</span></div>
        <div className="space-y-2"><div className="flex justify-between text-sm"><span>{t("agents.detail.maxTokensLabel")}</span><strong>{maxTokens}/8192</strong></div><input type="range" min="256" max="8192" step="256" value={maxTokens} onChange={(e) => setMaxTokens(Number(e.target.value))} /><span className="mt-1.5 text-xs text-muted-foreground">{t("agents.detail.maxTokensHint")}</span></div>
        <div className="space-y-2"><div className="flex justify-between text-sm"><span>{t("agents.detail.memoryLimitLabel")}</span><strong>{memoryLimit}/100</strong></div><input type="range" min="0" max="100" step="1" value={memoryLimit} onChange={(e) => setMemoryLimit(Number(e.target.value))} /><span className="mt-1.5 text-xs text-muted-foreground">{t("agents.detail.memoryLimitHint")}</span></div>
      </div></Card>
      <Card className="grid gap-6 p-5 md:grid-cols-[minmax(12rem,1fr)_2fr]"><div className="[&_h2]:font-semibold [&_p]:mt-1 [&_p]:text-sm [&_p]:text-muted-foreground"><h3 className="font-heading">{t("agents.detail.capabilitiesHeading")}</h3><p>{t("agents.detail.capabilitiesCopy")}</p></div><div className="space-y-4">
        <div className="rounded-lg border p-4">
          <label className="flex items-start justify-between gap-3"><Switch checked={imageEnabled} onCheckedChange={setImageEnabled} /><ImageIcon size={17} /><span><strong>{t("agents.detail.imageLabel")}</strong><small>{t("agents.detail.imageHint")}</small></span></label>
        ...
        <div className="rounded-lg border p-4">
          <label className="flex items-start justify-between gap-3"><Switch checked={audioEnabled} onCheckedChange={setAudioEnabled} /><AudioLines size={17} /><span><strong>{t("agents.detail.audioLabel")}</strong><small>{t("agents.detail.audioHint")}</small></span></label>
