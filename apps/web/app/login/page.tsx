  ...
  return (
    <main className="access-page agency-access">
      <header className="access-topbar">
        <div className="access-brand"><span className="openvoiss-icon"><img src="/brand/openvoiss-logo-original.png" alt="" /></span><strong>Openvoiss</strong></div>
      ...
      <div className="access-layout">
        <section className="access-intro">
          ...
          <div className="access-preview" aria-hidden="true">
            <header><div><span className="preview-logo openvoiss-icon"><img src="/brand/openvoiss-logo-original.png" alt="" /></span><strong>{t("auth.previewTitle")}</strong></div><small>{t("auth.previewToday")}</small></header>
