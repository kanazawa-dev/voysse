...
export default function ClientsPage() {
  ...
  return <div className="page">
    ...
    <div className="toolbar"><label className="search-box"><Search size={18} /><input value={search} onChange={(event) => setSearch(event.target.value)} placeholder={t("clients.list.searchPlaceholder")} /></label><span className="result-count">{t("clients.list.resultCount", { count: visible.length })}</span></div>
