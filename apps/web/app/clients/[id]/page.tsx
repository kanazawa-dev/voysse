...
export default function ClientDetailPage() {
  ...
  return <div className="flex w-full flex-col gap-6">
    ...
    <Tabs value={tab} onValueChange={(value) => setTab(value as typeof tab)}><TabsList variant="line" className="max-w-full justify-start overflow-x-auto"><TabsTrigger value="details"><Settings2 size={17} /> {t("clients.detail.tabDetails")}</TabsTrigger><TabsTrigger value="agents"><Bot size={17} /> {t("clients.detail.tabAgents")} <span>{client.agents.length}</span></TabsTrigger><TabsTrigger value="channels"><Radio size={17} /> {t("clients.detail.tabChannels")}</TabsTrigger><TabsTrigger value="inbox"><Inbox size={17} /> {t("clients.detail.tabInbox")}</TabsTrigger><TabsTrigger value="portal"><Globe2 size={17} /> {t("clients.detail.tabPortal")}</TabsTrigger></TabsList></Tabs>
