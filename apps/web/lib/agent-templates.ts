...
export const agentTemplates: AgentTemplate[] = [
  {
    ...
    description: { en: "Virtual waiter that answers menu questions and takes orders.", es: "Mesero virtual que responde sobre el menú y toma pedidos." },
    instructions: {
  ...
  },
  {
    ...
    description: { en: "Qualifies property leads and schedules viewings.", es: "Califica leads de inmuebles y agenda visitas." },
    instructions: {
  ...
  },
  {
    ...
    description: { en: "Answers patient questions and books appointments.", es: "Responde dudas de pacientes y agenda citas." },
    instructions: {
  ...
  },
  {
    ...
    description: { en: "Helps shoppers choose products and track orders.", es: "Ayuda a elegir productos y seguir pedidos." },
    instructions: {
  ...
  },
  {
    ...
    description: { en: "General support agent that answers frequent questions.", es: "Agente de soporte general que responde preguntas frecuentes." },
    instructions: {
