    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Reservas de reuniones: al pulsar un botón para conversar con Alex se carga un calendario de Cal.com dentro de un modal. Solo entonces tu navegador se conecta con este proveedor. Cal.com recopila tu nombre, correo y las respuestas que incluyas al reservar para organizar la reunión. No enviamos un formulario previo; también puedes abrir Cal.com directamente.",
          ...
          "Medición de canales: registramos contadores agregados por día UTC, canal indicado en utm_source y tipo de interacción (vista o clic en App, Docs, GitHub o calendario). No guardamos identificadores de visitante, direcciones IP, URL completa ni cookies para estas métricas; no vinculamos los contadores a cuentas. Los informes cubren hasta 90 días y los contadores antiguos se limpian gradualmente al recibir nuevos eventos. Respetamos las señales Do Not Track y Global Privacy Control del navegador.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Meeting bookings: clicking a button to speak with Alex loads a Cal.com calendar inside a dialog. Only then does your browser connect to this provider. Cal.com collects your name, email and answers provided when booking to organize the meeting. We do not submit a preliminary form; you can also open Cal.com directly.",
          ...
          "Channel measurement: we store aggregate counters by UTC day, utm_source channel and interaction (pageview or App, Docs, GitHub or calendar click). These metrics contain no visitor identifiers, IP addresses, full URLs or cookies, and are not linked to accounts. Reports cover up to 90 days; older counters are gradually removed when new events arrive. We respect browser Do Not Track and Global Privacy Control signals.",
