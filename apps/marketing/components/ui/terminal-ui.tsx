...
export interface TerminalIntroSequenceProps {
...
export function TerminalIntroSequence({ sequence, onComplete, className, style }: TerminalIntroSequenceProps) {
