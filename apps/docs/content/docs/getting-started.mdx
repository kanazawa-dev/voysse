...
description: "A first-run walkthrough: install Openvoiss, create your agency, and send your first AI-agent reply."
---
...
Docker see [Self-hosting](/docs/self-hosting); for the full environment
variable reference see [Configuration](/docs/configuration).
...
You need Docker (see [Self-hosting → Before you begin](/docs/self-hosting#before-you-begin)
...
per instance** (see [Self-hosting](/docs/self-hosting)), so this is normally
...
saved. See [AI providers](/docs/ai-providers) for provider-specific details
...
- **WhatsApp** (WhatsApp Cloud API or QR via Baileys) — see [Channels](/docs/whatsapp).
...
- [Architecture](/docs/architecture) — services, data model and tenant isolation.
- [Self-hosting](/docs/self-hosting) — deploy to a server, HTTPS, backups, upgrades.
